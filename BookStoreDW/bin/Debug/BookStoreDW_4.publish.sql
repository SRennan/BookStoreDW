...
ALTER TABLE [dbo].[FactOrders] WITH NOCHECK
    ADD CONSTRAINT [FK_DimDate_OrderDate] FOREIGN KEY ([Order_dateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
...
GO
ALTER TABLE [dbo].[FactOrders] WITH NOCHECK
    ADD CONSTRAINT [FK_DimDate_StatusDate] FOREIGN KEY ([Status_dateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
